...
class BillDetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bill_detail" do
    assert_difference("BillDetail.count") do
      post bill_details_url, params: { bill_detail: { EmID: @bill_detail.EmID, NameCus: @bill_detail.NameCus, Phonenumber: @bill_detail.Phonenumber, Product: @bill_detail.Product } }
    end
  ...
  test "should update bill_detail" do
    patch bill_detail_url(@bill_detail), params: { bill_detail: { EmID: @bill_detail.EmID, NameCus: @bill_detail.NameCus, Phonenumber: @bill_detail.Phonenumber, Product: @bill_detail.Product } }
